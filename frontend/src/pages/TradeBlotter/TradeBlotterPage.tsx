...
const columnDefs: ColDef<Trade>[] = [
  ...
  { field: "volume", headerName: "Volume (MMBtu)", width: 150, valueFormatter: (p) => Number(p.value).toLocaleString() },
  { field: "fixed_price", headerName: "Fixed price", width: 110, valueFormatter: (p) => `$${Number(p.value).toFixed(3)}` },
